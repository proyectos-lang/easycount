    ...
    operaciones: [
      ...
      },
      {
        ...
        pasos: [
          ...
          "Método de pago por factura: la plantilla trae la columna «Metodo de Pago» (Efectivo, Banco o Credito). Las que pongas en Credito quedan como cuenta por cobrar (sin pago). Si dejas la celda vacía, se usa el método por defecto que elijas en el diálogo.",
          "En el diálogo elige el cliente (o crea 'Consumidor Final'), el almacén/localización, el método por defecto y la cuenta bancaria (para las filas con Banco), y si aplica ISV.",
          "Sube el archivo: verás un resumen (facturas, líneas, total) y avisos de facturas duplicadas o productos no encontrados.",
          "Presiona 'Importar': cada factura se crea con las mismas transacciones que una venta normal (baja stock; las de contado ingresan a caja/banco, las de crédito quedan pendientes en Cuentas por Cobrar).",
        ],
      },
    ],
    faqs: [
